package cat.calidos.morfeu.s3.control;

import java.util.Map;

import cat.calidos.morfeu.control.MorfeuServlet;
import cat.calidos.morfeu.s3.control.injection.DaggerS3ControlComponent;
import cat.calidos.morfeu.webapp.injection.ControlComponent;


public class S3Servlet extends MorfeuServlet {

@Override
public ControlComponent getControl(String path, Map<String, String> params) {
	return DaggerS3ControlComponent.builder()
			.withPath(path)
